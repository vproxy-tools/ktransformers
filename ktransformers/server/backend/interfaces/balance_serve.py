...
def report_last_time_performance(profiler: Profiler):
        try:
            ...
            print(f'Total: prefill {prefill_count}')
            print(f'       decode  {decode_count}')
            print(f'Performance: prefill {prefill_count/prefill_time} T/s')
            print(f'                     {prefill_time*1000/prefill_count} ms/T')
            print(f'             decode  {decode_count/decode_time} T/s')
            print(f'                     {decode_time*1000/decode_count} ms/T')
            print(f'Time: tokenize {tokenize_time} s')
